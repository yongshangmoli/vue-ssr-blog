 ...
 * @LastEditTime: 2019-12-12 17:58:21
 * @LastEditors: shallwe
 -->
<template>
  <el-row
  ...
  <div v-else class="no-info">没有查到博客信息哦</div>
</template>
    ...
    export default {
        ...
        mounted() {
            ...
            var disqus_config = function() {
                this.page.url = isPrd ? 'https://supervv.cn' : 'localhost' // Replace PAGE_URL with your page's canonical URL variable
